...
const Inbox = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(
            `https://mailbox-7efdc-default-rtdb.firebaseio.com/${sanitizedEmail}/outbox.json`
            )
            .then((response) => {
            console.log(
        ...
        const deleteEmail = (key) => {
          axios
            .delete(
              `https://mailbox-7efdc-default-rtdb.firebaseio.com/${sanitizedEmail}/outbox/${key}.json`
            )
            .then((response) => {
