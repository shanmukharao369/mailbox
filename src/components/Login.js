...
const Login = () => {
  ...
  const ForgotPasswordHandler = () => {
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyDDKLpEsyTIABKYoeH_kRIVUxy5dAqg5z8",
      {
        method: "POST",
        body: JSON.stringify({
  ...
  const submitHandler = (e) => {
    ...
    if (EmailId === "" || Password === "") {
      ...
      fetch(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDDKLpEsyTIABKYoeH_kRIVUxy5dAqg5z8",
        {
          method: "POST",
          body: JSON.stringify({
            email: EmailId,
